...
//
//-------------------------------------------------
// Modified by Bar Harel for more icon
...
{
	SetPlayerMapIcon(playerid,0,2034.5853,-1404.4602,17.2588,22,0,MAPICON_LOCAL);
	SetPlayerMapIcon(playerid,1,1173.2719,-1323.8844,15.3940,22,0,MAPICON_LOCAL);
	SetPlayerMapIcon(playerid,2,2168.2124,-1673.1592,15.0827,24,0,MAPICON_LOCAL);
	SetPlayerMapIcon(playerid,3,2351.7803,-1167.4061,27.6647,24,0,MAPICON_LOCAL);
